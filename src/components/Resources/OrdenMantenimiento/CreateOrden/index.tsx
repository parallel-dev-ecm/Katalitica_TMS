...
function OrdenMantenimientoForm(): JSX.Element {
  ...
  const handleSaveChanges = async () => {
    ...
    if (updated) {
      const idOrdenReparacion = await getOrdenByFolio(folio);
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12}>
                    ...
                    <Grid item xs={12} sm={3}>
                      <MDButton
                        onClick={async () => {
                          ...
                          const dollyReq: EtAndKmRequest = {
                            kms: km_editable_dollys,
                            tipo_et: "DL",
                          };
                          const tractorReq: EtAndKmRequest = {
                            kms: km_editable_tractores,
                            tipo_et: "TR",
                          };
                          const remolqueReq: EtAndKmRequest = {
                            kms: km_editable_remolques,
                            tipo_et: "RM",
                          };

                          const remolque2Req: EtAndKmRequest = {
                          ...
                          if (remolqueReq.kms !== null) {
                            ...
                            console.log(showActividadesRemolque);
                          }
                    ...
                    <>
                      ...
                      <MDBox component="form" pb={3} px={3} ref={formRef}>
                        <Grid container spacing={3}>
                          ...
                          <Grid item xs={12} sm={4}>
                            <Autocomplete
                              options={allPlanesMantenimiento.map((option) => option.actividad)}
                              disabled={disabled}
                              onChange={async (event, newValue) => {
                                if (newValue) {
                                  const req: ClaveRequest = { clave: newValue };
                          ...
                          {/* <Grid item xs={12} sm={4}>
                            <FormField
                              disabled={disabled}
                              variant="outlined"
                              label="Actividad Mantenimiento"
                              onChange={handleChange(setActividadMantenimiento)}
                            />
                          </Grid> */}
                  ...
                  {showActividadesRemolque && (
                    <>
                      {console.log("test: ", showActividadesRemolque)}
                      <Grid item xs={12} sm={12}>
                        <DataTableNoLayout
                          dataTableData={{
